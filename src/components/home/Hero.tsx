...
export default function Hero() {
  return (
    <div>
        ...
        <div className='absolute inset-0 px-6 flex flex-col justify-center items-center text-white'>
          <p className="text-4xl text-center md:text-6xl lg:text-7xl font-serif text-white leading-tight">
